export const PRAGMATTO_LOGO_URL = "/logo.png";
...
export const siteContent = {
  ...
  careers: {
    title: "Join Our Team at Pragmatto",
    subtitle:
      "Discover a collaborative culture, meaningful impact, and flexibility in your career journey.",
    description:
      "At Pragmatto, we foster a collaborative culture, create meaningful impact, and prioritize flexibility and wellness for our employees. We continuously invest in upskilling our full-time team members.",
    roles: [
      {
      ...
      { title: "ERP Data Specialist", location: "Remote", type: "Full-Time" },
      {
  ...
  privacyPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "We collect information you voluntarily provide through contact forms, candidate resume submissions, and email inquiries (such as your full name, business email address, company name, phone number, and project requirements). We also collect standard non-identifying web analytics to optimize site functionality.",
      },
      {
      ...
      },
      {
        ...
        text: "We maintain strict administrative, technical, and physical safeguards designed to protect client and candidate data against unauthorized access, loss, or alteration.",
      },
      {
        heading: "Contact Us Regarding Privacy",
        text: "If you have questions or concerns about this Privacy Policy or your data, please contact us at info@pragmatto.com.",
      },
    ],
  },
};
